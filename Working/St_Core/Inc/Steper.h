...
float map2[]={1.5,       1.5,     1.9,    1.5,   	0.535,   	-0.545   ,  	0.443   , 	-0.545 	};
float map1[]={1.146,     0.6,     0.2,    0.6, 		0.123,  	-0.12 ,     	0.2  , 		0.123	 	};
float map0[]={-0.16,   	-0.16,  -0.4,   -0.625,  	-0.625  , 	-0.6, 		-0.6  , 	-0.16	};
...
float end_stop_down[3]={-1.2,		-1.6,			-1.6};
//////////////////////////////////////////////////////////////////////////////////////////////////
