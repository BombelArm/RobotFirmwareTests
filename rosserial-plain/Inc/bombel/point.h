#ifndef _ROS_SERVICE_point_h
#define _ROS_SERVICE_point_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char POINT[] = "bombel/point";

  class pointRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return POINT; };
    const char * getMD5(){ return "cc153912f1453b708d221682bc23d9ac"; };

  };

  class pointResponse : public ros::Msg
  {
    public:
